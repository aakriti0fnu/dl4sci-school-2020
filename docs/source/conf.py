...
project = 'dl4sci-school-2020'
copyright = '2020, Aakriti'
author = 'Aakriti'
...
#````````````Taken from https://github.com/sphinx-contrib/napoleon/blob/master/docs/source/conf.py ````````````#
...
html_theme_path = ["../.."]
html_logo = "demo/static/headshot.svg"
